...
// Web polyfill for react-native-sound
if (!RNSound) {
  RNSound = {
    IsAndroid: false,
    IsWindows: false,
    ...
    NSLibraryDirectory: '',
    NSCachesDirectory: '',
    prepare: function(filename, key, options, callback) {
      setTimeout(() => callback(null, { duration: 0, numberOfChannels: 2 }), 0);
    },
    play: function(key, callback) {
      setTimeout(() => callback(true), 0);
    },
    pause: function(key, callback) {
      setTimeout(() => callback(), 0);
    },
    stop: function(key, callback) {
      setTimeout(() => callback(), 0);
    },
    release: function(key) {},
    setVolume: function(key, volume, pan) {},
    setPan: function(key, pan) {},
    setLooping: function(key, looping) {},
    setSpeed: function(key, speed) {},
    setPitch: function(key, pitch) {},
    getCurrentTime: function(key, callback) {
      setTimeout(() => callback(0), 0);
    },
    setCurrentTime: function(key, time) {},
    setSpeakerphoneOn: function(key, value) {},
    enable: function(enabled) {},
    enableInSilenceMode: function(enabled) {},
    setActive: function(value) {},
    setCategory: function(value, mixWithOthers) {},
    setMode: function(value) {},
    setSpeakerPhone: function(value) {},
    getSystemVolume: function(callback) {
      setTimeout(() => callback(1), 0);
    },
    setSystemVolume: function(value) {},
  };
}
