...
import type { BasicInteropFunction, EnableCssInteropOptions, InteropFunction, JSXFunction } from "../types";
...
export declare const interopComponents: Map<string | object, InteropTypeCheck<any>>;
...
export declare function cssInterop<T extends {}, M>(component: ComponentType<T> | string, mapping: EnableCssInteropOptions<T> & M, interop?: InteropFunction): void;
