...
class FlatList extends React.PureComponent {
  ...
  _checkProps(props) {
    ...
    if (numColumns > 1) {
      ...
      (0, _invariant.default)(!columnWrapperStyle || (Array.isArray(columnWrapperStyle) && columnWrapperStyle.length === 0), 'columnWrapperStyle not supported for single column lists');
    }
